...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "비급여 진료비 서비스의 이용 조건, 정보의 성격과 한계, 저작권과 책임 범위를 안내합니다.",
});
    ...
    <>
      ...
      <section className="panel">
        ...
        <ul className="panel__desc" style={{ paddingLeft: 18, marginBottom: 0 }}>
          ...
          <li>
            사이트는 특정 병원을 추천하거나 중개하지 않으며, 의료기관과 환자
            사이의 진료 계약에 관여하지 않습니다.
          </li>
          <li>
            진료와 비용은 해당 의료기관에서 확인해야 합니다. 이 사이트의 정보는
            의학적 판단의 근거가 될 수 없습니다.
          </li>
        </ul>
      </section>
      ...
      <section className="panel">
        ...
        <ul className="panel__desc" style={{ paddingLeft: 18, marginBottom: 0 }}>
          ...
          <li>
            표시된 금액은 심사평가원이 공개한 <strong>2015~2016년 기준</strong>
            자료이며 현재 가격을 보장하지 않습니다.
          </li>
          <li>
